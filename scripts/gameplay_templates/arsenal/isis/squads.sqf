...
_rifleman_light = ["rifleman_light", ["carbine", 5, "None", false, false], 3, "normal", false, []];
_rifleman = ["rifleman", ["rifle", 6, "None", false, false], 3, "normal", false, []];
_rifleman_heavy = ["rifleman_heavy", ["rifle", 6, "holo", false, false], 3, "heavy", false, ["trained"]];
_grenadier = ["grenadier", ["riflegl", 6, "None", false, false], 8, "normal", true, ["gl"]];
...
_lat = ["lat", ["carbine", 5, "None", false, false], 0, "normal", false, ["lat"]];
...
_lmg = ["lmg", ["lmg", 5, "None", false, false], 2, "normal", false, []];
...
_spec_rifleman = ["spec_rifleman", ["rifle", 7, "holo", true, true], 4, "heavy", true, ["specops"]];
...
_spec_lat = ["spec_lat", ["carbine", 5, "None", true, true], 0, "normal", false, ["lat","specops"]];
...
_spec_lmg = ["spec_lmg", ["lmg", 5, "combat", true, true], 2, "heavy", true, ["specops"]];
 ...
 _light_sq = [_tl,_rifleman,_grenadier,_grenadier,_sharpshooter,_lat,_lmg];
 _patrol_sq = [_rifleman_light,_grenadier,_sharpshooter];
