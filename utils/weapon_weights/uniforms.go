// weapon_weights project uniforms.go
package main
...
func processUniforms(filepath *string, writeFiles bool) error {
	...
	uTpl, err := template.New("uniforms.tpl").ParseFiles("uniforms.tpl")
	if err != nil {
