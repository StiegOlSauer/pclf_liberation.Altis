// weapon_weights project main.go
package main
...
func main() {
	...
	if *vestsCsvPath != "" {
		...
		err := processVests(vestsCsvPath, *writeFiles)
		if err != nil {
	...
	if *opticsCsvPath != "" {
		...
		err := processOptics(opticsCsvPath, *writeFiles)
		if err != nil {
	...
	if *uniformsCsvPath != "" {
		...
		err := processUniforms(uniformsCsvPath, *writeFiles)
		if err != nil {
	...
	if *devicesCsvPath != "" {
		...
		err := processDevices(devicesCsvPath, *writeFiles)
		if err != nil {
	...
	if *itemsCsvPath != "" {
		...
		err := processCommonItems(itemsCsvPath, *writeFiles)
		if err != nil {
